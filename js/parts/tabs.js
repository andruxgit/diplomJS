        ...
        classWrapTab.addEventListener('click', (event) => {
          ...
          if (target) {
            for (let i = 0; i < classTab.length; i++) {
              ...
              if (target && (classWrapTab.getElementsByTagName('a')[i] == target ||
                  classWrapTab.getElementsByTagName('img')[i] == target ||
                  classWrapTab.getElementsByClassName('no_click')[i] == target ||
                  classWrapTab.getElementsByClassName('glazing_block')[i] == target)) {
                hideContent(0);
                showContent(i);
                unsetActivTab(i);
                break;
